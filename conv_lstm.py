...
def conv_lstm_cell(inputs,
  ...
  *this is a subsampling lstm which reduces size to 1/2 (with a stride 2 maxpool)
  ...
  if state is None:
    state_shape=[spatial_size[0]//2, spatial_size[1]//2, 2 * num_channels]
  ...
  with tf.variable_scope(scope,
    ...
    h=layers.conv2d_transpose(h,num_channels,[4,4],2)
    ...
    i_j_f_o = layers.conv2d(inputs_h,
                            ...
                            activation_fn=None,
                            scope='Gates')
    i_j_f_o=layers.max_pool2d(i_j_f_o,[2,2],stride=2)
