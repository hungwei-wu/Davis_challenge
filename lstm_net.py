...
import numpy as np
def lstm_deconv_layers(images_batch):
  """
  ...
  lstm_deconv1,deconvlstm_state1=deconv_lstm_cell(lstm_conv2, deconvlstm_state1, upscale=2, num_channels=48, scope='deconvstate1')
  lstm_deconv2,deconvlstm_state2=deconv_lstm_cell(lstm_deconv1, deconvlstm_state2, upscale=2, num_channels=2, scope='deconvstate2')
